...
1. Tidak ada perubahan kode — halaman HTML/CSS tetap sama persis dengan Jobsheet 3.
2. Tambah docs/wireframe.md: wireframe teks + user flow untuk fitur yang belum dibangun (Login, Dashboard Petugas, Peminjaman, Pengembalian, Riwayat).
